...
vc_map( array(
    'name' => esc_html__('Half Donut Chart', 'gogreen'),
    'description' => esc_html__('Animated half donut chart.', 'gogreen'),
    ...
    'params' => array(
            ...
            array(
                'param_name' => 'content',
                'type' => 'textarea_html',              
                'heading' => esc_html__('Description', 'gogreen'),                
            ...
            array(
                ...
                'admin_label' => true,            
                'description' => esc_html__('Input chart value here. Choose range between 0 and 100.', 'gogreen')
            ),
            array(
            ...
            array(
                ...
                'value' => array(
                    esc_html__('Default', 'gogreen') => '', 
                    esc_html__('45 degree', 'gogreen') => '45', 
